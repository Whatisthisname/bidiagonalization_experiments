...
Applying Hessenberg factorization to this constructed input yields
...
$$\bar{Q} = \begin{bmatrix}\mathbf{0} & l_1 & \mathbf{0} & l_2 & \cdots & \mathbf{0} & l_k \\ r_1 & \mathbf{0} & r_2 & \mathbf{0} &  \cdots & r_k & \mathbf{0} \end{bmatrix} \in \mathbb{R}^{(N+M) \times K} \qquad \bar{r} :=\begin{pmatrix}\mathbf{0} \\ r \end{pmatrix}$$
